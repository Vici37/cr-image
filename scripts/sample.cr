...
image.gaussian_blur(1).save("gaussian_1_sample.jpg").save("docs/images/gaussian_1_sample.jpg")
image.gaussian_blur(5).save("gaussian_5_sample.jpg").save("docs/images/gaussian_5_sample.jpg")
